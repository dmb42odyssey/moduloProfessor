...
import datatype.accessibility.Guideline;

import java.util.HashMap;
import java.util.Map;

public class GuidelineDatabase {

    public Map<String, Integer> principleToGuidelineNumber = new HashMap<>();

    public GuidelineDatabase()
    {
        principleToGuidelineNumber.put(PrincipleDatabase.PrincipleConstants.Perceivable,4);
        principleToGuidelineNumber.put(PrincipleDatabase.PrincipleConstants.Operable,4);
        principleToGuidelineNumber.put(PrincipleDatabase.PrincipleConstants.Understandable, 3);
        principleToGuidelineNumber.put(PrincipleDatabase.PrincipleConstants.Robust, 1);
    }
    ...
    public static AbstractGuideline GuidelineInitialization(String principleName, String guidelineName)
    {
        ...
        {
            case PrincipleDatabase.PrincipleConstants.Perceivable:
            {
                return selectPerceivableGuideline(guidelineName);
            }
            case PrincipleDatabase.PrincipleConstants.Operable:
            {
                return selectOperableGuideline(guidelineName);
            }
            case PrincipleDatabase.PrincipleConstants.Understandable:
            {
                return selectUnderstandableGuideline(guidelineName);
            }
            case PrincipleDatabase.PrincipleConstants.Robust:
            {
